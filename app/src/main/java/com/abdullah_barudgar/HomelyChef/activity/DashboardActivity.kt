...
import com.abdullah_barudgar.HomelyChef.fragment.*
import com.abdullah_barudgar.HomelyChef.fragment.RestaurantFragment.Companion.resId
import com.abdullah_barudgar.HomelyChef.util.DrawerLocker
import com.abdullah_barudgar.HomelyChef.util.SessionManager
        ...
        navigationView.setNavigationItemSelectedListener { item: MenuItem ->
            ...
            * We delay it by 0.1 second*/
            ...
            when (item.itemId) {
                ...
                R.id.aboutChefs -> {
                    val chefsFragment = AboutChefs()
                    fragmentTransaction.replace(R.id.frame, chefsFragment )
                    fragmentTransaction.commit()
                    supportActionBar?.title = "About Chefs"
                }
